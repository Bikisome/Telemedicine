...
const HospitalDirectory = () => {
  ...
  return (
    <Box sx={{ bgcolor: '#f8fafc', minHeight: '100vh' }}>
      ...
      >
        <Toolbar>
          <Typography variant="h5" component="div" sx={{ flexGrow: 1, color: 'primary.main', fontWeight: 600 }}>
            MedDirectory
          </Typography>
        </Toolbar>
      </AppBar>
      ...
      <Container maxWidth="xl" sx={{ py: 6 }}>
        ...
        >
          ...
          <Typography variant="h6" sx={{ opacity: 0.9, maxWidth: 600 }}>
            Connect with India's leading healthcare institutions and experienced medical professionals
          </Typography>
        </Paper>

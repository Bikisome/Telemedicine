...
import { 
  Search, Calendar, Clock, DollarSign, 
  Activity, FileText, ArrowRight, TrendingUp 
} from 'lucide-react';
...
const PreviousConsults = () => {
  ...
  const consultations = [
    ...
    },
    {
      ...
      avatar: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQvA-i6vache-k99dtI4ThSgnPJctyvMkBmiIsM1VgHyUGFIZwyXaJdo-I&s"
    }
  ];

  const totalSpending = consultations.reduce((total, consult) => total + consult.fee, 0);
  ...
  const filteredConsultations = consultations.filter(consult => {
    const matchesSearch = consult.doctorName.toLowerCase().includes(searchTerm.toLowerCase()) ||
              ...
              >
                <div className="flex justify-between items-start">
                  <div className="flex gap-4">
                    ...
                    />
                    <div>
                      <h3 className="font-semibold text-lg">{consult.doctorName}</h3>
        ...
        {activeTab === 'analytics' && (
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div>
                <h3 className="font-semibold mb-4">Consultations by Specialty</h3>
                <div className="h-64">
                    ...
                    >
                      ...
                      <div className="bg-gray-200 rounded-full h-2">
                        <motion.div
                          ...
                          initial={{ width: 0 }}
                          animate={{ width: `${(count / consultations.length) * 100}%` }}
          ...
          >
            ...
            <div className="flex justify-between items-start mb-4">
                <div className="flex gap-4">
                  ...
                  />
                  <div>
                    <h3 className="text-xl font-bold">{selectedConsult.doctorName}</h3>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div className="bg-gray-50 rounded-lg p-3">
                  <div className="text-gray-600 text-sm mb-1">Duration & Fee</div>
                  <div className="font-medium flex items-center gap-2">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                {selectedConsult.followUp && (
                  <div className="flex items-center gap-2 px-4 py-2 bg-green-100 text-green-800 rounded-lg">
                    <Calendar className="h-4 w-4" />
                    Follow-up: {new Date(selectedConsult.followUp).toLocaleDateString()}
                  </div>
                )}
